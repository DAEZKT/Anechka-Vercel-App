         ...
         <header className="flex flex-col xl:flex-row justify-between xl:items-end gap-6 bg-white p-4 md:p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div className="flex flex-col lg:flex-row gap-4 items-stretch lg:items-center">
               ...
               <button
                  ...
                  disabled={loading}
                  className="w-full lg:w-auto justify-center bg-violet-600 hover:bg-violet-700 text-white px-5 py-3 rounded-xl font-bold shadow-lg shadow-violet-500/30 transition-all flex items-center gap-2 transform active:scale-95 text-sm"
               >
